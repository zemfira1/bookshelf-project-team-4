...
</div>`})(e)).join("");o.innerHTML=n,r.style.display="none"}}M=new URL(i("kyEFX").resolve("aZh2v"),import.meta.url).toString(),document.querySelector(".amazon-link"),document.querySelector(".bookshop-link"),document.querySelector(".applebooks-link"),document.addEventListener("DOMContentLoaded",D),document.addEventListener("click",function(e){if(console.log(e.target),e.target.classList.contains("book-card-remove")||e.target.classList.contains("book-card-remove-icon")){let t=e.target.getAttribute("data-bookid");console.log(t),function(e){let t=O(),o=t.filter(t=>t._id!==e);localStorage.setItem("bookShopingListLS",JSON.stringify(o)),D()}(t)}}),window.addEventListener("DOMContentLoaded",function(){let e=document.querySelector('a[data-action="index"]');e.classList.add("current");let t=window.location.href;if(t.endsWith("/shopping-list.html")){e.classList.remove("current");let t=document.querySelector('a[data-action="shopping-list"]');t.classList.add("current")}});
//# sourceMappingURL=shopping-list.ebc886ad.js.map
