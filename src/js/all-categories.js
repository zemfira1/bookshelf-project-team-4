...
async function addMarkupCategoryList() {
  try {
    ...
    const markUp = response
      ...
      <a class="category-link" href="#" data-name="${list_name}">
      <span class="category-link-text" data-name="${list_name}">${list_name}</span>
      </a></li>`;
      })
      .join('');
    return `<ul class="category-list">
      <li class="category-item">
      <a class="category-link" href="#" data-name="All categories">
      <span class="category-link-text current-category" data-name="All categories">All categories</span>
      </a></li>
      ${markUp}
    </ul>`;
  } catch (error) {
    ...
    return `<ul class="category-list">
      <li class="category-item">
      <a class="category-link" href="#" data-name="All categories">
      <span class="category-link-text current-category">All categories</span>
      </a></li></ul>`;
  }
}
